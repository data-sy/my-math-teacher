...
- **U6 — goal 정의:** **A(권장) 최고 시급도 카드의 drill-down 루트 프론티어**(§3.2 — 하향 순회 불필요·항상 정의·와이어프레임 정합·reason 과 타이브레이크 공유) / B 위상순 마지막 카드 — 계산 최저렴하나 와이어프레임 의미(카드 위의 도달 목표)와 불일치 / C top-N 최상위 후수 탐색 — 하향 순회 신규 + fan-out 미정의로 기각.
