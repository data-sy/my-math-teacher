...
- **[M1] 테스트 인프라 및 기준선 구축** — [milestone](milestones/milestone-1-test-infrastructure.md)
...
- 성능 튜닝 프로젝트 (1M 사용자 / 3M 주문 스케일링, 포트폴리오화 완료)
- Redis Sorted Set 기반 캐싱 도입
- MySQL EXPLAIN 기반 복합 인덱스 최적화
- ADR 정책 정착 (17개 누적)
