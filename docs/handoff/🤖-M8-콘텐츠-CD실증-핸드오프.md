...
> 작성: 2026-08-07 · **기준 갱신 2026-08-13** = `feat/m7-item-selection` `c0fa5d8`(**미푸시 7** — 이후 README 포트폴리오 재작성 4커밋 추가) · `feat/m8-concept-links` `dcd1894`(미푸시 5) · 프로덕션 라이브
> ⚠️ 두 브랜치 모두 origin 에 없다 — 착수 전 push 또는 머지 여부를 먼저 정할 것.
