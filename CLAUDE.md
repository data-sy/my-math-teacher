...
- [Roadmap](ROADMAP.md)
- M2(Neo4j→MySQL CTE)·M4(무중단 배포) 완료(2026-07-06, PR #45). 현재 = **M7 제품 피벗 진행 중**(Step 4: **spec-01 머지 완료(PR #48, 2026-07-14)** — 다음 = **spec-02(React) 착수**: 브랜치 `feat/m7-spec-02-react-mvp`, 새 세션. 핸드오프 = `docs/milestones/m7-step4-handoff.md`) / M5 관측성(Grafana/Prometheus) 착수 대기 / M3(Neo4j 폐기) Next. 정본은 항상 `ROADMAP.md`.
