...
- [Roadmap](ROADMAP.md)
- M2(Neo4j→MySQL CTE)·M4(무중단 배포) 완료(2026-07-06, PR #45). 현재 = **M7 제품 피벗 진행 중**(Step 4: spec-01 머지 완료(PR #48) → **프론트 재설계 — 와이어프레임 6종 사인오프 완료(2026-07-17, `docs/design/v2/`), 다음 = 프론트 spec 재작성(spec-02)**) / M5 관측성(Grafana/Prometheus) 착수 대기 / M3(Neo4j 폐기) Next. 정본은 항상 `ROADMAP.md`.
