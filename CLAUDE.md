...
- [Roadmap](ROADMAP.md)
- M2(Neo4j→MySQL CTE)·M4(무중단 배포) 완료(2026-07-06, PR #45). 현재 = **M7 제품 피벗 진행 중**(Step 1 기획·Step 2 UX 설계 완료, 다음 = Step 3 기술 설계 spec-01~03) / M5 관측성(Grafana/Prometheus) 착수 대기 / M3(Neo4j 폐기) Next. 정본은 항상 `ROADMAP.md`.
